...
> [!NOTE] 
> Adhat hozzá felhasználókat és az egyéb csoportok is egy csoportot az Azure ad-ben az Azure portál használatával. Azonban ahhoz, hogy egy egyszerű szolgáltatásnév hozzáadása egy csoporthoz, használja a [az Azure AD PowerShell modul](../active-directory/active-directory-accessmanagement-groups-settings-v2-cmdlets.md).
> 
> ```powershell
