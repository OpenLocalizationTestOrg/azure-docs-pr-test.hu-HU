...
[A Microsoft Azure használati és RateCard API-k engedélyezése Cloudyn ITFM adja meg az ügyfelek számára](billing-usage-rate-card-partner-solution-cloudyn.md) Azure számlázási API partner által kínált integrációs élményt ismerteti [Cloudyn](https://www.cloudyn.com/microsoft-azure/). Ez a cikk tapasztalataikat beszél, és tartalmazza a videó bemutatja, hogyan segítségével Cloudyn és az Azure számlázási API-k mélyebb betekintés az Azure fogyasztási adatokhoz.
