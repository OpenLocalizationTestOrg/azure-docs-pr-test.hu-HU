...
description: "További tudnivalók az Azure-előfizetés módosítása, és váltson egy másik ajánlatra az előfizetés-kezelési portáljának használatával"
services: 
documentationcenter: 
author: genlin
manager: jlian
...
---
# <a name="switch-your-azure-subscription-to-another-offer"></a>Az Azure-előfizetéshez Váltás másik ajánlatra

Mint egy [használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) vevő, váltson az Azure-előfizetéshez a másik ajánlatra a [Account Center](https://account.windowsazure.com/Subscriptions). Például használhatja ez a funkció előnyeit a [Visual Studio-előfizetők a havi kreditek](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/). Ha a számítógép [ingyenes](https://azure.microsoft.com/free/), megtudhatja, hogyan [váltson használatalapú fizetés](billing-upgrade-azure-subscription.md).

## <a name="whats-supported"></a>Támogatott források és műveletek:

| A | – |
| --- | --- |
| [Használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) |[Fejlesztés/tesztelés – használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0023p/) |
| [Használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) |[A Visual Studio Professional](https://azure.microsoft.com/offers/ms-azr-0059p/) |
| [Használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) |[A Visual Studio Test Professional](https://azure.microsoft.com/offers/ms-azr-0060p/) |
| [Használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) |[MSDN platformok](https://azure.microsoft.com/offers/ms-azr-0062p/) |
| [Használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) |[A Visual Studio Enterprise](https://azure.microsoft.com/offers/ms-azr-0063p/) |
| [Használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/) |[A Visual Studio Enterprise (Bizspark)](https://azure.microsoft.com/offers/ms-azr-0064p/) |
...
## <a name="why-cant-i-switch-offers"></a>Miért nem lehet átállítani a ajánlatok?

Előfordulhat, nem látható a **Váltás másik ajánlatra** gombra kattint, ha:

* Ön nem on [használatalapú fizetés](https://azure.microsoft.com/offers/ms-azr-0003p/). Jelenleg csak a használatalapú fizetés előfizetések váltáshoz másik ajánlatra.
...
Megjelenhet **nincsenek nincsenek ajánlatok elérhető az Ön régióban vagy ország jelenleg** ha:

* Ön nem jogosult az olyan ajánlat kapcsolót. Ellenőrizze a [átválthat elérhető ajánlatok listájának](#whats-supported).
...
> [!NOTE]
> A számlázással kapcsolatos korlátok miatt ajánlat kapcsolók a következők nem lehetséges-előfizetés létrehozása után az első számlázási ciklusban.
>
>
...
* Kriptográfiai Szolgáltató áttelepítéséhez lásd: [Azure előfizetés áttelepítési CSP-hez](https://blogs.technet.microsoft.com/hybridcloudbp/2016/08/26/azure-subscription-migration-to-csp/).
