...
| [MessageLockLostException](/dotnet/api/microsoft.servicebus.messaging.messagelocklostexception) |Az üzenethez társított zárolási-token érvényessége lejárt, vagy a zárolás jogkivonat nem található. |Az üzenet eldobásakor. |Nem nyújt az újra gombra. |
| [SessionLockLostException](/dotnet/api/microsoft.servicebus.messaging.sessionlocklostexception) |Ehhez a munkamenethez társított zárolási elvész. | Megszakítja a [MessageSession](/dotnet/api/microsoft.servicebus.messaging.messagesession) objektum. |Nem nyújt az újra gombra. |
