...
hello első lépéseként tooretrieve hello hálózati figyelőt példány. Ez a változó átadása toohello `Get-AzureRmNetworkWatcherSecurityGroupView` parancsmag.
