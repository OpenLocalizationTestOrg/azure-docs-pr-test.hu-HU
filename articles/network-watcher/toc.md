...
## Ellenőrizze a virtuális IP-adatfolyamok tooand
### [Portál](network-watcher-check-ip-flow-verify-portal.md)
...
## [Csomag rögzítésekre toofind rendellenességeket elemzése](network-watcher-deep-packet-inspection.md)
## [Használja a csomag rögzítési toodo proaktív hálózatfigyelés az Azure Functions](network-watcher-alert-triggered-packet-capture.md)
