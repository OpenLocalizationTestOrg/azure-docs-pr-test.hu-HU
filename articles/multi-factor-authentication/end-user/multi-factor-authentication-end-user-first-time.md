...
Az IT-részleg igényel indíthatja a kétlépéses ellenőrzést, akkor megjelenik egy képernyő, amely szerint **a rendszergazda előírta, állítsa be ezt a fiókot, a további védelem ellenőrzési**:
