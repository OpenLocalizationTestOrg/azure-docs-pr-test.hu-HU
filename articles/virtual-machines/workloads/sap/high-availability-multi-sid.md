...
2016 szeptemberétől a Microsoft, amely egy szolgáltatás, ahol kezelheti több virtuális IP-cím használatával egy [Azure belső terheléselosztó][load-balancer-multivip-overview]. Ez a funkció már létezik a hello Azure külső terheléselosztó.
...
> [!NOTE]
> Ez a funkció csak a hello Azure Resource Manager üzembe helyezési modellben érhető el.
...
4. [Hello adatbázis-példány telepítése][sap-ha-guide-9.2].  
 Ebben a lépésben kívánja telepíteni az adatbázis-kezelő egy dedikált WSFC-fürtre.

5. [Hello második fürtcsomóponton telepíteni][sap-ha-guide-9.3].  
