...
* Ha a toobring saját freebsd rendszerű tooAzure, olvassa el túl[létrehozása és feltöltése egy freebsd rendszerű virtuális merevlemez tooAzure](classic/freebsd-create-upload-vhd.md).
