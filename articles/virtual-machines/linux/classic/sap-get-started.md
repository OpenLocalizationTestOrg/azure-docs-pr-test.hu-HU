...
Microsoft Azure virtuális gépekkel Microsoft biztosít az átfogó infrastruktúra (IaaS) szolgáltatás platformként. Az Azure virtuális gépek támogatják az SAP NetWeaver-alapú alkalmazásokat (IaaS). az alábbi hello tanulmányok ismertetik, hogyan tooplan és megvalósítása SAP NetWeaver alapú alkalmazások a Windows virtuális gépek Azure-ban. SAP NetWeaver-alapú alkalmazások valósítja meg a [Windows virtuális gépek](../../windows/classic/sap-get-started.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).
...
[Ez a cikk itt található](../../virtual-machines-linux-sap-on-suse-quickstart.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
