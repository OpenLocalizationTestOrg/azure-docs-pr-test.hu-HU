...
* Ha azt szeretné, hogy a saját freebsd rendszerű Azure, tekintse meg [létrehozása és feltöltése az Azure-bA freebsd rendszerű virtuális merevlemez](linux/classic/freebsd-create-upload-vhd.md).
