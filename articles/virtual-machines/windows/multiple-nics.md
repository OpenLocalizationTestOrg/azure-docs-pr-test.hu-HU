...
Részletes információk, beleértve a saját PowerShell-parancsfájlok belül több hálózati adapter létrehozása: [több hálózati Adapterből virtuális gépek telepítése](../../virtual-network/virtual-network-deploy-multinic-arm-ps.md).
...
A virtuális hálózati adapter hozzáadása egy meglévő virtuális Gépre, a virtuális gép felszabadítása adja hozzá a virtuális hálózati Adaptert, majd indítsa el a virtuális Gépet.
