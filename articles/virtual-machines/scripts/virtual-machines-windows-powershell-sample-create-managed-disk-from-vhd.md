...
[!code-powershell[fő](../../../powershell_scripts/virtual-machine/create-managed-disks-from-vhd-in-different-subscription/create-managed-disks-from-vhd-in-different-subscription.ps1 "létrehozás felügyelt lemezes virtuális merevlemezből")]
