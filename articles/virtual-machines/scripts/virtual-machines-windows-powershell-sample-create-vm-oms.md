...
Ezt a parancsfájlt hoz létre egy Azure virtuális gép, hello Operations Management Suite (OMS) agent szolgáltatást telepíti, és regisztrálja az OMS-munkaterület hello rendszer. Miután hello parancsfájl lefutott, hello virtuális gép hello OMS konzolban látható lesz. Emellett kell tooupdate hello OMS munkaterület azonosítója és a munkaterület kulcsot.
