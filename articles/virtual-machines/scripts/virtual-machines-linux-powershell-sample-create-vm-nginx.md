...
Ez a parancsfájl létrehoz egy Azure virtuális gépet, és ezután hello Azure virtuális gép egyéni parancsprogramok futtatására szolgáló bővítmény tooinstall NGINX. Hello parancsprogram futtatása után a nyilvános IP-címe hello hello virtuális gép egy bemutató webhelyen érheti el.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Adja hozzá a virtuális gép bővítmény toohello virtuális gépet. Ez a példa hello egyéni parancsprogramok futtatására szolgáló bővítmény használt tooinstall NGINX. |
