...
Ezt a parancsfájlt hoz létre egy virtuális gép Docker engedélyezve van, és elindítja egy futó NGINX tároló. Hello parancsprogram futtatása után hello NGINX webkiszolgáló hello hello Azure virtuális gép teljes Tartományneve keresztül is elérheti. 
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Adja hozzá a virtuális gép bővítmény toohello virtuális gépet. Ez a példa hello Docker bővítmény használt tooconfigure Docker és egy NGINX Docker-tároló futtassa. |
