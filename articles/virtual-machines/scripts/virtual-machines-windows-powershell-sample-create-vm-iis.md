...
Ezt a parancsfájlt hoz létre a Windows Server 2016 rendszert futtató Azure virtuális gépeket, és ezután hello Azure virtuális gép egyéni parancsprogramok futtatására szolgáló bővítmény tooinstall IIS. Hello parancsprogram futtatása után hello alapértelmezett IIS-webhely nyilvános IP-cím hello hello virtuális gép végezheti el.
