...
Ezt a parancsfájlt egy Azure virtuális gépet hoz létre Ubuntu rendszert és a kapcsolódó hálózati erőforrások. Hello parancsprogram futtatása után hello virtuális gép SSH-n keresztül érheti el.
