...
A lap [Azure Web Apps, a Cloud Services és a virtuális gépek összevetése](app-service-web/choose-web-site-cloud-service-vm.md) további információk a kiválasztása egy számítási modellt biztosít.
