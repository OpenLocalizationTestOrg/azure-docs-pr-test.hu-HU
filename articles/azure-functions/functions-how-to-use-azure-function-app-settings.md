...
App Service-beállításokkal kapcsolatos további információkért lásd: [Azure App Service beállításainak konfigurálása](../app-service-web/web-sites-configure.md).
