...
1. Az Azure AD B2C belül **alkalmazások** panelen, nyissa meg a webes API-alkalmazás ("Contoso API").
...
1. Keresse meg a **alkalmazások** menüjében a B2C funkciók panelje.
