...
- **Minimális verziója**: a tároló frissítési, győződjön meg arról, a Microsoft Azure Recovery Services (MARS) ügynök legalább 2.0.9070.0 verziója. Ha a MARS agent régebbi, mint 2.0.9070.0, frissítse az ügynököt a frissítési folyamat megkezdése előtt.
...
**Miért nem olvashatom a feladatok adatokat a helyszíni erőforrások frissítés után**</br>
Figyelés a helyszíni biztonsági mentések (a MARS agent, a DPM és az Azure Backup Server) az új szolgáltatása, ha a Recovery Services-tároló frissítenie a mentési tárolóba. A figyelési adatokat a szolgáltatás-vel való szinkronizálásának 12 órát vesz igénybe.
