...
Ha ismeri az automatizálás [Futtatás mint fiók](automation-sec-configure-azure-runas-account.md) runbookok a szolgáltatás egyszerű, a PowerShell-parancsfájl a megadott helyett létrehozása hitelesítéséhez a a futtató fiókot a portálról, létrehoz egy új kapcsolódási eszköz használatával az alábbi Példaparancsok.  
