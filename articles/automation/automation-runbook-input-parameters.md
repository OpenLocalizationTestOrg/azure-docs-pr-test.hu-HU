...
| **Tulajdonság** | **Leírás** |
|:--- |:--- |
| Típus |Szükséges. A paraméter értéke a várt adattípus. A .NET-típus érvénytelen. |
| Név |Szükséges. A paraméter neve. Ez a runbookon belül egyedi és is csak betűket, számokat, vagy aláhúzás karaktereket tartalmazhat. Betűvel kell kezdődnie. |
...
Ha Ön [elindítja a runbookot](automation-starting-a-runbook.md#starting-a-runbook-with-the-azure-portal), a **runbook meghívása** panel nyílik meg, és beállíthatja, hogy az imént létrehozott paraméter értékét.
