...
-   Kerülje a `single-transaction` mysqldump, ha nagyon nagy adatbázisok vonatkozó beállítást. Sok tábla egy tranzakción belül vonatkozó hatására a megnövelt tárhely és a felhasznált memória-erőforrások visszaállítása és a teljesítmény működés lelassulhat, vagy az erőforrás-korlátozások.
-   Használjon többértékű Beszúrások minimálisra csökkenthetők utasítás végrehajtása terhelést, amikor való kiírása az adatbázisok SQL betöltése közben. Mysqldump segédprogram által létrehozott biztonsági másolat fájlok használatakor többértékű Beszúrások alapértelmezés szerint engedélyezve vannak. 
