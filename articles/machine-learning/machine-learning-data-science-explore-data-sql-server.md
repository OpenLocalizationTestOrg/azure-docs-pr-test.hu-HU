...
Most már használhatja a Pandas DataFrame, a témakörben tárgyalt [Azure Blobadatok folyamat adatok tudományos környezetében](machine-learning-data-science-process-data-blob.md).

## <a name="cortana-analytics-process-in-action-example"></a>A művelet példa Cortana Analytics folyamat
A Cortana Analytics folyamat egy nyilvános adatkészlet-végpontok közötti forgatókönyv például, [a csapat adatok tudományos folyamat működés közben: SQL Server használatával](machine-learning-data-science-process-sql-walkthrough.md).
