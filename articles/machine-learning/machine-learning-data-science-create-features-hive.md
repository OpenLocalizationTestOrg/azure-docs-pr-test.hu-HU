...
* Az adatok az Azure HDInsight Hadoop-fürtök Hive táblák fel lett töltve. Ha még nem, kövesse [létrehozása és az adatok betöltése a Hive táblák](machine-learning-data-science-move-hive-tables.md) feltölteni az adatokat a Hive táblák először.
