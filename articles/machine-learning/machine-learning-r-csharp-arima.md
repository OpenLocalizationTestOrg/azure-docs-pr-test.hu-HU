...
---
# <a name="deprecated-forecasting---autoregressive-integrated-moving-average-arima"></a>(elavult) Az előrejelzés - Autoregressive integrált áthelyezése átlagos (ARIMA)
...
Ez a szolgáltatás 4 argumentumként fogadja, és hello elemhez tartozó ARIMA előrejelzések számítja ki.
...
Többféleképpen is az automatizált módon hello szolgáltatás fel (egy példa alkalmazás [Itt](http://microsoftazuremachinelearning.azurewebsites.net/ArimaForecasting.aspx)).
...
Azure Machine Learning belül egy új üres kísérlet létrehozásához. A minta bemeneti adatok feltöltése egy előre meghatározott adatkapcsolatú sémával. Csatolt toohello adatok sémája egy [R-parancsfájl végrehajtása] [ execute-r-script] modult, amely hello elemhez tartozó ARIMA előrejelzési modell állít elő, az r "auto.arima" és "előrejelzés" függvény használatával 
...
Ez az elemhez tartozó ARIMA előrejelzési egy nagyon egyszerű példa. A fenti példa kódot hello is látható, nincs hiba alatt van megvalósítva, és hello szolgáltatás feltételezi, hogy minden hello változók értékei folyamatos/pozitív és hello gyakoriság 1-nél nagyobb egész számnak kell lennie. hello dátum és az érték vektorok hosszának hello azonos kell hello. hello dátum változó toohello formátum "hh/nn/éééé" kell igazodnia.

## <a name="faq"></a>GYIK
Gyakori kérdések a felhasználási webszolgáltatás hello vagy közzétételi toomarketplace, lásd: [Itt](machine-learning-marketplace-faq.md).
