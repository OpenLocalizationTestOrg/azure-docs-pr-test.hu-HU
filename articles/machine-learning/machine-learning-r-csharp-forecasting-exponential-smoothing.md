...
---
# <a name="deprecated-forecasting---exponential-smoothing"></a>(elavult) Az előrejelzés - beállításáról
...
Ez a szolgáltatás 4 argumentumként fogadja, és hello ETS előrejelzések számítja ki.
...
Többféleképpen is az automatizált módon hello szolgáltatás fel (egy példa alkalmazás [Itt](http://microsoftazuremachinelearning.azurewebsites.net/etsForecasting.aspx)).
...
Azure Machine Learning belül egy új üres kísérlet létrehozásához. A minta bemeneti adatok feltöltése egy előre meghatározott adatkapcsolatú sémával. Csatolt toohello adatok sémája egy [R-parancsfájl végrehajtása] [ execute-r-script] modul által generált hello ETS előrejelzési modell r "ets" és "előrejelzési" funkciókat használatával 
