...
A mérnöki és funkciók kiválasztása része egy, a csapat adatok tudományos folyamat (TDSP) című témakörben ismertetett [Mi az az Team tudományos folyamat?](data-science-process-overview.md). A szolgáltatás termékgondozó csoportja és a kijelölés részét képezik a **szolgáltatások fejlesztéséhez** a TDSP lépését.
