...
* SQL Server adatait tárolja. Ha nem, olvassa el [adatok áthelyezése az Azure SQL Database az Azure Machine Learning](machine-learning-data-science-move-sql-azure.md) útmutatást nem helyezi át az adatokat.
...
Most a témakörök kiterjed a Pandas adatok keret dolgozhat [létrehozása az Azure blob storage adatok Panda szolgáltatásai](machine-learning-data-science-create-features-blob.md).
