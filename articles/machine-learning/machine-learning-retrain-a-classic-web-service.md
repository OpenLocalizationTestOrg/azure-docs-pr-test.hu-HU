...
4. Írja be nevét és leírását, az új végpont. Válassza ki a naplózási szint, és hogy engedélyezve van-e mintaadatokat. További információt a naplózást, [naplózását a Machine Learning webszolgáltatások](machine-learning-web-services-logging.md).
...
5. Kattintson a lap alján **végpont hozzáadása**. Végpontok hozzáadásával kapcsolatos további információkért lásd: [végpontok létrehozása](machine-learning-create-endpoint.md). 
...
[A klasszikus Azure Machine Learning webszolgáltatás átképezési hibaelhárítása](machine-learning-troubleshooting-retraining-models.md)
