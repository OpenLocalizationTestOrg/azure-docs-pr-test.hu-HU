...
* A [ **adattudomány Linux virtuális gép**](https://azure.microsoft.com/marketplace/partners/microsoft-ads/linux-data-science-vm). A virtuális gép további információkért lásd: [a Linux adatok tudományos virtuális gép kiépítéséhez](machine-learning-data-science-linux-dsvm-intro.md).
...
Válassza ki **beállítások** a bal oldali menüben. Megjegyzés: a **MUNKATERÜLET azonosítója**. ![2](./media/machine-learning-data-science-linux-dsvm-walkthrough/workspace-id.png)

Válassza ki **engedélyezési jogkivonatok** az általános menüből, és vegye figyelembe a **elsődleges engedélyezési jogkivonat**.![ 3](./media/machine-learning-data-science-linux-dsvm-walkthrough/workspace-token.png)
