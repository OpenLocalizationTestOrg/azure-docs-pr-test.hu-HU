...
Ez a témakör ismerteti az adatok áthelyezése a Machine Learning Azure SQL adatbázis beállításait, lásd: [adatok áthelyezése az Azure SQL Database az Azure Machine Learning](machine-learning-data-science-move-sql-azure.md).
