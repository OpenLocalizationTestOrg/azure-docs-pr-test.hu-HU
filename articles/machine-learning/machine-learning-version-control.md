...
Az Azure Machine Learning egy trained model olyan formátumra .iLearner fájlként ismert szerializált, és az Azure Blob storage-fiók a munkaterület társított tárolja. Egyik módja a .iLearner fájl példánya van a megőrzési API-n keresztül. [Ez a cikk](machine-learning-retrain-models-programmatically.md) azt ismerteti, hogyan működik, a megőrzési API-t. A magas szintű lépéseket:
...
Sok azonos a webszolgáltatás végpontjainak is létrehozhat, és a végpontnak hasonló hatás eléréséhez a .iLearner fájl különböző verzióinak majd javítás. [Ez a cikk](machine-learning-create-models-and-endpoints-with-powershell.md) részletesebben ismerteti, hogyan hajthatja végre, hogy.
...
* Megtudhatja, hogyan [létrehozása és kezelése a nagy számú gépi tanulás modellek csak egyetlen kísérlet használatával](machine-learning-create-models-and-endpoints-with-powershell.md) PowerShell és az átképezési API segítségével.
