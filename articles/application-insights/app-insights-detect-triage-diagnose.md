...
* Teljesítmény. Szeretnék tudni, hogyan válaszidők eltérő kérelem Count; milyen mértékű CPU, a hálózati, a lemez és az egyéb erőforrások használják; és ahol a szűk keresztmetszeteket.
...
**Mi volt végezzük?** Ha a probléma nem jelenik meg, egy függőségi találhatók, és azt nem mindig van, az oka valószínűleg a legutóbbi változás. A metrika és az esemény diagramok által biztosított korábbi perspektíva egyszerűen hirtelen módosításokat összefüggéseket központi telepítéssel. Amely típusra van szűkítve le a keresse meg a problémát.
