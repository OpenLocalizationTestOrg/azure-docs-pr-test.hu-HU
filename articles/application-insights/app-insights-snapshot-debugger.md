...
3. Módosítsa a `ConfigureServices` módszer az alkalmazás `Startup` osztály hozzáadása a pillanatkép-gyűjtő telemetriai processzor. A kódot, hozzá kell adnia a Microsoft.ApplicationInsights.ASPNETCore NuGet csomag hivatkozott verziójától függ.
...
* [Állítsa be a snappoints a kódban](https://azure.microsoft.com/blog/snapshot-debugger-for-azure/) kivétel várakozás nélkül pillanatképek eléréséhez.
