...
3. A **áttekintése** lapon láthatja, hogy a tartomány jelenleg telepítése folyamatban van. A felügyelt tartományra nem konfigurálható, amíg a teljes mértékben ki van építve. Azt a felügyelt tartomány teljesen kiépített egy órát is tarthat.
