...
---
# <a name="deploy-your-on-premises-storsimple-device-in-hello-government-portal"></a>A helyszíni StorSimple eszköz hello kormányzati portál telepítése
[!INCLUDE [storsimple-version-selector-deploy-gov](../../includes/storsimple-version-selector-deploy-gov.md)]

## <a name="overview"></a>Áttekintés
Üdvözli a tooMicrosoft Azure StorSimple eszköztelepítő útmutatójában. Ezek az üzembehelyezési oktatóanyagok toohello a StorSimple 8000 Series Update 1 szoftverek futtatását a hello Azure Government Portal alkalmazni. Ez az oktatóanyag-sorozat ismerteti, hogyan tooconfigure a StorSimple eszközt, és tartalmazza a konfigurációs ellenőrzőlistát, konfigurációs előfeltételeket és részletes konfigurációs lépéseket.
...
| &nbsp; |Szolgáltatásregisztrációs kulcs |Ez a kulcs hello Azure-portálon jön létre. | |
