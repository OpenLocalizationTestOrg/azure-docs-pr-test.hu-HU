...
> [!IMPORTANT]
> Mielőtt eltávolítása és cseréje egy PCM, tekintse át a hello biztonsági adatokat a [StorSimple hardver összetevő cseréje](storsimple-hardware-component-replacement.md).
> 
> 
...
1. Hello a klasszikus Azure portálon, kattintson **eszközök** > **karbantartási** > **hardverállapot**. Hello PCM összetevők alatt hello állapotának ellenőrzése **megosztott összetevők** tooidentify, amely PCM sikertelen volt:
...
8. Győződjön meg arról, hogy sikeres volt-e helyettesítő hello: hello a StorSimple Manager szolgáltatás a klasszikus Azure portálon, lépjen a túl**eszközök** > **karbantartási**  >  **Hardverállapot**. A **megosztott összetevők**, hello PCM hello állapota zöld kell lennie. 
