...
> [!IMPORTANT]
> Mielőtt eltávolítása és cseréje egy tartományvezérlő, tekintse át a hello biztonsági adatokat a [StorSimple hardver összetevő cseréje](storsimple-hardware-component-replacement.md).
> 
> 
...
1. A hello a klasszikus Azure portálon, válassza a toohello StorSimple Manager szolgáltatáshoz, kattintson a hello **eszközök** fülre, majd hello eszköz, amelyet az toomonitor hello nevét.
2. Nyissa meg túl**karbantartási > hardverállapot**. vagy a vezérlő 0, vagy a vezérlő 1 hello állapota kell piros, ami azt jelenti, hogy hiba.
...
8. Hello vezérlő újraindítását követően ellenőrizze hello **tartományvezérlő állapotát** és hello **állapot fürt** hello Azure klasszikus portál tooverify, hogy a vezérlő hello hátsó tooa kifogástalan állapotban és a melegtartalék módban van .
...
4. Amikor hello zárolás dokkolása helyen végzett. Hello **OK** LED most kell lennie.  
   ...
   > 
   > 
5. tooverify, amely hello helyettesítő sikeres, a klasszikus Azure portál, nyissa meg túl hello**eszközök** > **karbantartási** > **hardverállapot**, és győződjön meg arról, hogy a vezérlő 0 és 1. vezérlő is meg Kifogástalan (állapota zöld színnel).
...
* [Hello Azure klasszikus portál tooidentify hello aktív vezérlővel használatával](#use-the-azure-classic-portal-to-identify-the-active-controller)
...
### <a name="use-hello-azure-classic-portal-tooidentify-hello-active-controller"></a>Hello Azure klasszikus portál tooidentify hello aktív vezérlővel használatával
A klasszikus Azure portálon hello, keresse meg a túl**eszközök** > **karbantartási**, és görgessen toohello **tartományvezérlők** szakasz. Itt ellenőrizheti, melyik tartományvezérlő aktív.

![Aktív azonosítsa a klasszikus Azure portálon](./media/storsimple-controller-replacement/IC752072.png)

**6. ábra** Azure klasszikus portál ábrázoló hello aktív vezérlő
