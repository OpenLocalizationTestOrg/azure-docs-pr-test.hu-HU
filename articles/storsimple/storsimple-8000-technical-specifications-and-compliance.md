...
hello StorSimple eszköz két 100-240 V kettős ventilátor, SBB-kompatibilis Power hűtési modulok (PCMs) rendelkezik. Ez lehetővé teszi egy redundáns power konfigurációt. Egy PCM meghibásodásakor hello eszköz toooperate a szokásos módon folytatódik a hello más PCM, amíg hello modul nem cseréli le.
...
Most már áll készen toodeploy a StorSimple eszköz az adatközpontban található. További információkért lásd: [központi telepítése a helyszíni eszközök](storsimple-8000-deployment-walkthrough-u2.md).
