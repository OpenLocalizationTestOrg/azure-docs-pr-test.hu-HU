...
A konfigurációs kiszolgáló szoftvert kell telepíteni a VMware magas rendelkezésre állású virtuális gépen. A következő táblázat felsorolja a minimális hardver-, szoftver, és hálózati követelményei a konfigurációs kiszolgáló.
