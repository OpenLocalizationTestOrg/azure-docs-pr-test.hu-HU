...
Azure biztosít a .NET-alkalmazások üzemeltetését több ajánlatokat. A különböző ajánlatok összehasonlítása érhető el [Azure App Service, a Cloud Services és a virtuális gépek összevetése](../app-service-web/choose-web-site-cloud-service-vm.md). Ha a vendég operációs rendszer, az elérhető .NET 4.6.1 rugalmas tranzakciók szükséges kisebb, a vendég operációs rendszer frissítéséhez 4.6.1 szüksége. 
