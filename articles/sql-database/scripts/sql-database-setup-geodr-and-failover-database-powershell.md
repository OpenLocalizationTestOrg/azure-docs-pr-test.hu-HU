...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-single-azure-sql-database"></a>PowerShell tooconfigure aktív georeplikáció egyetlen Azure SQL-adatbázis használata

A PowerShell-mintaparancsfájl egy Azure SQL-adatbázis aktív georeplikáció konfigurálja, és átadja azt tooa hello Azure SQL adatbázis másodlagos replikája.
