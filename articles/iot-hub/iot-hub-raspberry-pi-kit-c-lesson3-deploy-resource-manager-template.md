...
* A `main.c` fájlt a `app` almappában a kulcs forrásfájl. A forrásfájl üzenet küldése 20 alkalommal az IoT hub, és minden üzenetet küld a LED villogni kódját tartalmazza.
...
[Futtassa a mintaalkalmazást eszközről a felhőbe üzenetek küldése](iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md)
