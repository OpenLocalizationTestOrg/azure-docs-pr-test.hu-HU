...
| A két eszközfrissítésekhez (címkék és tulajdonságait) | Kettős eszközfrissítésekhez az eszközt, az eszközről van szó, az 512 bájtos adattömbök üzeneteihez. Például egy 6 KB-os eszköz iker olvasása díjfizetéssel 12 üzeneteihez. |
...
Az eszköz akkor 25 (100KB/4 KB-os) üzenetek * eszközről a felhőbe üzenetek, valamint 1 üzenetet 24 órát * 6 napi időpontot az eszközfrissítésekhez két, összesen 156 üzenet naponta.
...
Az összes, az eszköz és a megoldás háttérrendszeréhez 185 üzenet naponta felhasználását.
