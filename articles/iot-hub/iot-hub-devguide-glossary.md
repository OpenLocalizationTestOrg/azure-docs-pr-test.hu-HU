...
A [Microsoft Azure-portálon](https://portal.azure.com) a központi hely, ahol kioszthatja és az Azure erőforrások kezeléséhez. A tartalom használatával szervezi _paneleken_. Egyes az IoT-központ oktatóanyagok kérheti használatára a [a klasszikus Azure portálon](https://manage.windowsazure.com).
