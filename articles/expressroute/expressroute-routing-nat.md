...
* Ha egy /29 alhálózatot használ, az két /30 alhálózatra lesz felosztva. 
  * először hello/30 alhálózati hello elsődleges hivatkozáshoz használja, hello második/30-as alhálózat hello másodlagos hivatkozást fog történni.
...
Ha úgy dönt, hogy toouse a.b.c.d/29 tooset társviszony-létesítés hello fel, akkor lesznek osztva a két/30-as alhálózatokra. Hello az alábbi példában szereplő követően áttekintjük hello a.b.c.d/29 alhálózati használatáról. 
...
Győződjön meg arról, hogy az IP-cím és mivel number egy, az alább felsorolt hello nyilvántartó regisztrált tooyou vannak.
...
A Microsoft fog címkét előtagok meghirdetett nyilvános társviszony keresztül, és a Microsoft társviszony-létesítés megfelelő BGP közösségi értékek hello régió hello előtagok jelző tárolt. Hello közösségi értékek toomake megfelelő útválasztási döntések toooffer számíthat [optimális útválasztási toocustomers](expressroute-optimize-routing.md).
