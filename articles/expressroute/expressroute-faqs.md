...
Hozzon létre egy útvonal-szűrő, válassza ki a használni kívánt szolgáltatásokat, és csatolja a szűrőt a Microsoft társviszony-létesítés. Útmutatásért lásd: [konfigurálása útvonal szűrők a Microsoft társviszony-létesítéshez](how-to-routefilter-powershell.md).
