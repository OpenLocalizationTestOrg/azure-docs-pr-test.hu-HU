...
#### [Hive View hello használata](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Hello a HDInsight tools for Visual Studio használata](hdinsight-hadoop-use-hive-visual-studio.md)
#### [A Távoli asztal használata](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Hello lekérdezés konzol használata](hdinsight-hadoop-use-hive-query-console.md)
...
### [Hello MapReduce minták futtatása](hdinsight-hadoop-run-samples-linux.md)
...
#### [Hello .NET SDK használata](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Írási tooData Lake Store](hdinsight-storm-write-data-lake-store.md)
...
### [A HDInsight Tools toocreate Spark-alkalmazások használata](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [A HDInsight Tools toodebug Spark-alkalmazások SSH keresztül távolról használata](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Kapcsolódás Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Csatlakozás hello Hive JDBC-illesztőt használatával](hdinsight-connect-hive-jdbc-driver.md)
...
### [HDInsight tooyour a helyszíni hálózat](connect-on-premises-network.md)
...
#### [REST tooinstall alkalmazások használata](https://msdn.microsoft.com/library/mt706515.aspx)
#### [A HDInsight-alkalmazások tooAzure piactér közzététele](hdinsight-apps-publish-applications.md)
## Biztonságos
...
### [Hozzáférés toodata korlátozása](hdinsight-storage-sharedaccesssignature-permissions.md)
## Kezelés
...
#### [Használja a cURL és hello Azure REST API](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Hello .NET SDK használata](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Hello Azure CLI használata](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Hello Azure portál használata](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Hello Azure CLI használata](hdinsight-administer-use-command-line.md)
### [Hello Ambari webes felhasználói felület-fürtök kezelése](hdinsight-hadoop-manage-ambari.md)
...
### [TooResource Manager Fejlesztőeszközök áttelepítése](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Rendelkezésre állás és megbízhatóság](hdinsight-high-availability-linux.md)
### [HDInsight-fürt toonewer verzió frissítése](hdinsight-upgrade-cluster.md)
...
#### [Használja az Ambari nézetek toodebug Tez feladatokhoz](hdinsight-debug-ambari-tez-view.md)
...
# Kapcsolódó
## Windows-fürtök
### [Windows-fürtök tooLinux fürtök áttelepítése](hdinsight-migrate-from-windows-to-linux.md)
### [.NET megoldások tooLinux fürtök áttelepítése](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Giraph tooprocess nagyméretű diagramjait használata](hdinsight-hadoop-giraph-install.md)
...
### [Maven toobuild Java-alkalmazások használata](hdinsight-hbase-build-java-maven.md)
### [Tez felhasználói felület toodebug Tez feladatokhoz hello használata](hdinsight-debug-tez-ui.md)
...
### [A figyelő fürtökhöz hello Ambari API használatával](hdinsight-monitor-use-ambari-api.md)

# Erőforrások
## [Azure-ütemterv](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Segítség hello fórum](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
