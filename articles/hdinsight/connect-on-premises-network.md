...
> [!NOTE]
> Az alábbi lépéseket használja a [Azure-portálon](https://portal.azure.com) egy Azure virtuális gép létrehozásához. Egyéb módon hozhat létre a virtuális gép, tekintse meg a [hozzon létre Virtuálisgép - Azure CLI](../virtual-machines/linux/quick-create-cli.md) és [hozzon létre Virtuálisgép - Azure PowerShell](../virtual-machines/linux/quick-create-portal.md) dokumentumok.
