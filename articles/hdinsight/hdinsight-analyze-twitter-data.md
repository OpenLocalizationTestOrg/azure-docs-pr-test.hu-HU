...
Ebben az oktatóanyagban a Windows PowerShell használandó ellenőrizze a webes szolgáltatás hívása. .NET C# mintát, lásd: [elemzése a HBase a hdinsight eszközben valós idejű Twitter sentiment][hdinsight-hbase-twitter-sentiment]. A webszolgáltatás-hívások egyéb népszerű eszköz [ *Curl*][curl]. Curl letölthető [Itt][curl-download].
