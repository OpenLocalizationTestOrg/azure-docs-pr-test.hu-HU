...
1. Másolja a Hive JDBC-illesztőprogramok a HDInsight-fürthöz.
    ...
    * A **Linux-alapú HDInsight**, tegye a következőket a szükséges jar-fájlok letöltésére.
    ...
    * A **Windows-alapú HDInsight**, tegye a következőket a jar-fájlok letöltésére.
        ...
        2. A távoli asztalt panelt kell használni a **Connect** gombra kattintva csatlakozzon a fürthöz. A távoli asztal nincs engedélyezve, ha ezen a képernyőn adjon meg egy felhasználónevet és jelszót, majd válasszon **engedélyezése** távoli asztal engedélyezése a fürthöz.

            ![Távoli asztali panel](./media/hdinsight-connect-hive-jdbc-driver/remotedesktopblade.png)

            Miután kiválasztott **Connect**, egy .rdp le. Ez a fájl segítségével indítsa el a távoli asztali ügyfél. Amikor a rendszer kéri, a felhasználónév és a távoli asztal eléréséhez megadott jelszó használata.
...
6. A következő értékeket használja a **hozzáadása Alias** párbeszédpanel.
 ...
 ![Adja hozzá a alias párbeszédpanel](./media/hdinsight-connect-hive-jdbc-driver/addalias.png)
    ...
    Használja a **teszt** gombra kattintva győződjön meg arról, hogy működik-e a kapcsolat. Ha **csatlakozni: hdinsight Hive** kiválasztása párbeszédpanel jelenik meg, **Connect** a vizsgálat végrehajtásához. Ha a teszt sikeres, megjelenik egy **sikeres kapcsolat** párbeszédpanel.
...
**A jelenség**: HDInsight-fürtök 3.3-as vagy 3.4-es verziójú való csatlakozáskor jelenhet meg, amely a váratlan hiba történt hiba. Az alábbi veremkivonatban találhatók a hiba a következő sorokat kezdődik:
...
**OK**: Ez a hiba oka nem egyeznek a commons-codec.jar fájl SQuirreL, és a szükséges a Hive JDBC-összetevők által használt verziójában.
