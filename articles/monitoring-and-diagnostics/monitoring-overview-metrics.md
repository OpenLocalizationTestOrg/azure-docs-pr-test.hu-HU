...
* Használja a [Azure figyelő metrikák REST API](https://msdn.microsoft.com/library/mt743622.aspx) a tényleges metrikai adatok eléréséhez.

> [!NOTE]
> Ez a cikk ismerteti a metrikák keresztül a [új API-t a metrikák](https://msdn.microsoft.com/library/dn931930.aspx) az Azure-erőforrások. Az API-verzió az új metrikai meghatározásainak API 2016-03-01 és metrikáihoz API verziója 2016-09-01. Az örökölt metrikai meghatározásainak és a metrikák elérhető verzió 2014-04-01 API-val.
>
>
...
Riasztási szabályok metrikák a konfigurálható. Ezek a riasztási szabályok ellenőrizheti, ha egy metrika elért egy bizonyos küszöböt. Azok ezután e-mailben értesítse arról, vagy egy egyéni parancsfájlok futtatásához használható webhook érvényesítést. A webhook segítségével is konfigurálhatja a harmadik féltől származó terméket integrációja.
...
Az Azure figyelő egy új metrikus infrastruktúrája. Az Azure-szolgáltatásokat az Azure-portál és az új verzió a Azure API támogatja:
