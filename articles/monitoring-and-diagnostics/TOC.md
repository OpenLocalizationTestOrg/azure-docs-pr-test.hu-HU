...
## Hello tevékenységnapló használata
...
### [Az adatfolyam tevékenység napló tooEvent hubok](monitoring-stream-activity-logs-event-hubs.md)
...
### [Telepítse át a tooActivity napló riasztások](monitoring-migrate-management-alerts.md)
...
### [Az adatfolyam tooEvent hubok](monitoring-stream-diagnostic-logs-to-event-hubs.md)
...
## Hello REST API-t használja
### [A REST API használatának bemutatója](monitoring-rest-api-walkthrough.md)
## Az Azure Diagnostics bővítmény használata
### [TooApplication Insights küldése](azure-diagnostics-configure-application-insights.md)
### [Küldési tooEvent hubok](azure-diagnostics-streaming-event-hubs.md)
