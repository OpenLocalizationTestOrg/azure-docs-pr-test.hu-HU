...
---
# <a name="how-tooperform-live-streaming-with-on-premises-encoders-using-net"></a>Hogyan tooperform élő adatfolyam helyszíni kódolókkal .NET használatával
...
Ez az oktatóanyag végigvezeti hello hello Azure Media Services .NET SDK toocreate használatával egy **csatorna** , amely átmenő közvetítésre van konfigurálva. 
...
Ajánlott tooreview hello a következő cikkeket:
...
a következő példakód hello bemutatja, hogyan tooachieve hello a következő feladatokat:

* Connect tooMedia szolgáltatások
* Csatorna létrehozása
* Frissítés hello csatorna
* Hello csatorna bemeneti végpont beolvasása. hello bemeneti végpontot kell megadni a toohello a helyszíni élő kódoló. hello élő kódoló konvertálja jeleinek hello kamera toostreams toohello csatorna bemeneti küldött (betöltési) végpont.
* Hello csatorna előnézeti végpont lekérése
* Hozzon létre, és egy programot elindítani
* A szükséges tooaccess hello program egy kereső létrehozása
...
Információ az élő kódolók tooconfigure lásd: [Azure Media Services RMTP-támogatása és valós idejű kódolók](https://azure.microsoft.com/blog/2014/09/18/azure-media-services-rtmp-support-and-live-encoders/).
