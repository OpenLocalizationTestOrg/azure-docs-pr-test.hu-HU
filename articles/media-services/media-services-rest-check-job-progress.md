...
Feladatok futtatása, ha gyakran van szüksége egy módon tootrack feladat előrehaladását. Hello feladat állapota azt is megtudhatja, hello feladat állapota tulajdonság használatával. Az állapot tulajdonság hello további információkért lásd: [entitás Feladattulajdonság](https://docs.microsoft.com/rest/api/media/operations/job#job_entity_properties).
