...
Annak meghatározásához, hogy használ-e helyi gyorsítótár, ellenőrizze, hogy az App Service **Alkalmazásbeállítások** fülre. Ha a helyi gyorsítótár használatban van, az alkalmazás beállítása `WEBSITE_LOCAL_CACHE_OPTION` értéke `Always`. Helyi gyorsítótárával kapcsolatos további információkért lásd: a [App szolgáltatás helyi gyorsítótárából áttekintése](https://docs.microsoft.com/azure/app-service/app-service-local-cache).
