...
Konfigurálhatja az App Service-környezetek hivatkoznak [dokumentációban](app-service-web-how-to-create-an-app-service-environment.md) a témáról. Miután egy App Service-környezet létrehozása, létrehozhat [webalkalmazások](app-service-web-overview.md), [API-alkalmazások](../app-service-api/app-service-api-apps-why-best-platform.md) és [Mobile Apps](../app-service-mobile/app-service-mobile-value-prop.md) ebben a környezetben, amely az összes védi a konfigurálását a következő szakaszban végezzük WAF mögött.
