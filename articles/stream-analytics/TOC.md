...
### [Kimeneti tooAzure funkciók](stream-analytics-functions-redis.md)
### [Kimeneti tooData Lake Store](stream-analytics-data-lake-output.md)
### [Kimeneti tooDocumentDB](stream-analytics-documentdb-output.md)
...
### [Skála tooincrease átviteli sebesség](stream-analytics-scale-jobs.md)
...
### [Hello Management .NET SDK használata](stream-analytics-dotnet-management-sdk.md)
