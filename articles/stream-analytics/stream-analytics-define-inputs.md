...
> [!NOTE]
> A Stream Analytics nem támogatja a tartalom hozzáadása egy meglévő blob. A Stream Analytics csak egyszer tekinthetik blob, és a módosítások után a feladat számára az adatok olvasása a BLOB előforduló nincsenek feldolgozva. Az ajánlott eljárás az egyszer töltse fel az adatokat, majd nem adja hozzá események, hogy a blob-tárolóba.
> 
