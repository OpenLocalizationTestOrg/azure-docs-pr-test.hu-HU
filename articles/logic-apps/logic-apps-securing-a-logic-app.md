...
A helyszíni hibrid kapcsolat funkció az Azure API és a Web apps segítségével helyszíni kommunikációhoz.  Hibrid kapcsolatok és konfigurálása a részletek megtalálhatók [ebben a cikkben](../app-service-web/web-sites-hybrid-connection-get-started.md).
