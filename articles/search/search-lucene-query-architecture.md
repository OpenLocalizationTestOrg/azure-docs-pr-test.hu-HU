...
A feltételek fordított index létrehozásához a keresőmotor lexikális elemzés a dokumentumok tartalmát, hasonló mi történik, a lekérdezés feldolgozása közben keresztüli hajt végre. Szöveg bemenetek átadni egy analyzer alsó cased absztrakt, és így tovább, a analyzer konfigurációjától függően az újrafoglalások. Általános, de nem szükséges, az azonos elemzőkkel használandó keresési és indexelési műveletek, hogy lekérdezési kifejezések mint belül az index feltételeket is.
