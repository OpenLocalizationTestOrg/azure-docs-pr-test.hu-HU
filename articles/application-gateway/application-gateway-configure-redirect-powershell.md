...
Alkalmazásátjáró hello képességét tooredirect forgalmat egy adott konfigurációnak megfelelően támogatja. További kapcsolatos általános helyezést átirányítását toolearn [Alkalmazásátjáró átirányítási áttekintése](application-gateway-redirect-overview.md). Ez a cikk a HTTP-átirányítás tooHTTPS példákat tartalmaz, az elérési utat átirányítja a többhelyes átirányításokat, és átirányítja a felhasználókat tooexternal helyek.

## <a name="http-toohttps-redirect-on-an-existing-application-gateway"></a>A meglévő Alkalmazásátjáró átirányítási HTTP tooHTTPS

hello alábbi példa létrehoz egy új HTTP-figyelő a 80-as port tooredirect kérelmek toohello létező figyelőt a 443-as porton.
...
Miután hello Alkalmazásátjáró frissül, tesztelje a hello új figyelő 80-as porton.  hello alábbi példa azt mutatja használatával `curl` hello átirányítási tesztelése.
...
a következő példa hello hoz létre egy új figyelő és alapú elérésiút-szabály, amely átirányítja a értekezlet hello adott URL-címe csak a forgalom meglévő Alkalmazásátjáró.
...
hello alábbi példa hoz létre egy új Alkalmazásátjáró 2 többhelyes figyelői 80-as porton. hello figyelői adatum.com és adatum.org vonatkoznak. Az átirányítási létrejön egy szabály tooredirect forgalom a adatum.org tooadatum.com. További konfigurálni kell a CNAME aliasok toohello alkalmazás átjáró nyilvános IP-cím, további információt a tartományi tooAzure DNS delegálásának konfigurálása, és rögzíti a tartomány fel által létrehozott CNAME rekord, [tartomány delegálása tooAzure DNS](../dns/dns-delegate-domain-azure-dns.md).
...
## <a name="redirect-tooan-external-site"></a>Az átirányítási tooan külső webhely

hello alábbi példa átirányítja a felhasználókat hello alkalmazás átjáró tooan külső webhelyen (bing.com) érkező forgalmat. Hello használatakor `TargetUrl` kapcsoló hello `IncludePath` és `IncludeQuery` kapcsolók használata nem engedélyezett.
...
Látogasson el [end tooend SSL konfigurálása az Alkalmazásátjáró PowerShell használatával](application-gateway-end-to-end-ssl-powershell.md)
