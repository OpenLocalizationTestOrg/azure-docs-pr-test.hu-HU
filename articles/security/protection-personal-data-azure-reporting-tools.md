...
A vállalat védelmét kell beállítani, hogy az alkalmazottak és a felhasználók személyes adatok védelme keresztül egy többrétegű biztonsági stratégia Azure felügyeleti és biztonsági szolgáltatások használatával ugyanazok a hozzáférést és a személyes adatok szigorú vezérlőit, és képesnek kell lennie bemutatják a védelmi intézkedések a belső és külső auditorok.
