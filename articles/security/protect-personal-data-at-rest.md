...
A vállalati adatok ezen osztályok (például a bérszámfejtési és foglalások részlegek) igénylő elérhetővé tétele közben kell védeni az alkalmazottak és a felhasználók személyes adatok védelme. A személyes adatok kívül a vállalat által felügyelt adatközpont tárolja, és nem a vállalat fizikai ellenőrzés alatt áll.
