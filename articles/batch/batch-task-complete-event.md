...
# <a name="task-complete-event"></a>A feladat befejeződésének eseményét.
 ...
 Ez az esemény kibocsátott, ha egy feladat befejeződött, függetlenül hello kilépési kódot. Ez az esemény is lehet használt toodetermine hello időtartamának, ahol a hello feladat futott, és hogy azt újra lett.


 hello következő példa bemutatja hello törzsét egy feladat befejeződésének eseményét.
