...
**Hibrid kapcsolatok Web Apps használatával létrehozásához**, lásd: [Azure Web Apps csatlakozzon az On-Premises erőforráshoz](../app-service-web/web-sites-hybrid-connection-get-started.md). A hibrid kapcsolat Manager (HCM) a webalkalmazásról, amely az előnyben részesített módszer is telepíthet. 
...
A webes alkalmazás vagy az Azure App Service Mobile Apps összekapcsolása egy meglévő hibrid kapcsolat, válassza ki a **meglévő hibrid kapcsolat használata** a hibrid kapcsolatok paneljén. Lásd: [hozzáférés a helyszíni erőforrások hibrid kapcsolatok használata az Azure App Service](../app-service-web/web-sites-hybrid-connection-get-started.md).
...
[Csatlakozás Azure-webalkalmazásokban egy helyszíni erőforráshoz](../app-service-web/web-sites-hybrid-connection-get-started.md)  
[Kapcsolódás a helyi SQL Server az Azure-webalkalmazásokban](../app-service-web/web-sites-hybrid-connection-connect-on-premises-sql-server.md)   
