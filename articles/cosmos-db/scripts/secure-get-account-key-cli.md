...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Kulcsait lekérése Azure Cosmos Adatbázisba hello Azure parancssori felület használatával
...
| [az cosmosdb lista-kulcsok](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Hogy a gazdagépek hello SQL Database logikai kiszolgáló létrehozása. |
