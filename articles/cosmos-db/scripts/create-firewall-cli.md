...
[!code-azurecli-interactive[fő](../../../cli_scripts/cosmosdb/secure-cosmosdb-create-firewall/secure-cosmosdb-create-firewall.sh?highlight=38-42 "hozzon létre egy Azure Cosmos DB tűzfal")]
...
| [az cosmosdb frissítés](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Frissíti a tűzfal beállításait adja meg Azure CosmosDB fiókot. |
