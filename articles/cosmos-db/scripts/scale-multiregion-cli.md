...
---
# <a name="replicate-an-azure-cosmos-db-database-account-in-multiple-regions-and-configure-failover-priorities-using-hello-azure-cli"></a>Egy Azure Cosmos DB adatbázisfiók több régióba replikálja, és konfigurálja a feladatátvételi prioritások hello Azure parancssori felület használatával

Ez a minta bármilyen Azure Cosmos DB adatbázisfiók több régióba replikálja, és konfigurálja a feladatátvételi prioritások hello Azure parancssori felület használatával.
