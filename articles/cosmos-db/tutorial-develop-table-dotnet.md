...
Az Azure Table Storage továbbra is használható nagy tárigényű és alacsonyabb átviteli sebességet megkövetelő táblákkal. Azure Cosmos DB bevezet egy jövőbeli frissítéssel tárolási optimalizált táblák támogatása, és a meglévő és új Azure Table storage-fiókok zökkenőmentesen frissíti az Azure Cosmos DB.
...
- rendelkezésre állás 99,99 % belül egy régiót, és a magas rendelkezésre állás érdekében további régiókban hozzáadásának lehetősége és [iparágvezető átfogó SLA](https://azure.microsoft.com/support/legal/sla/cosmos-db/) az általánosan rendelkezésre álló
