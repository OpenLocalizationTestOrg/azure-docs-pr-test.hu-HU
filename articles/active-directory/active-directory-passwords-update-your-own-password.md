...
3. Az informatikai részleg által konfigurált SSPR-beállításoktól függően a következők valamelyike jelenik meg. Ön vagy az informatikai munkatársak az információk a cikk használata előtt van kitöltve [az önkiszolgáló jelszó-változtatási regisztrációs](active-directory-passwords-reset-register.md).
