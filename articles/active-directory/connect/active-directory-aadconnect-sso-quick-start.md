...
>[!IMPORTANT]
>A zökkenőmentes SSO-funkció jelenleg előzetes verzió.
...
- Az Azure AD Connect kommunikálhatnak `*.msappproxy.net` URL-címek és a 443-as porton alatt. Ezt az előfeltételt csak engedélyezi a szolgáltatást, nem a tényleges felhasználói bejelentkezések esetén alkalmazható.
- Az Azure AD Connect közvetlen IP kapcsolatokat létesíthetik számára a [Azure adatközpont IP-címtartományok](https://www.microsoft.com/download/details.aspx?id=41653). Ebben az esetben a előfeltétel csak akkor, ha a funkció engedélyezéséhez, alkalmazható.
...
Számára, hogy a szolgáltatás a felhasználók számára, szeretné hozzáadni a két Azure AD URL-címet (https://autologon.microsoftazuread-sso.com és https://aadg.windows.net.nsatc.net) felhasználók Intranet zóna beállításainak az Active Directory csoportházirend segítségével.
