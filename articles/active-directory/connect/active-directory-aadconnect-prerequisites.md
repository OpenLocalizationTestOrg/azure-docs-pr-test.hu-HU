...
* Az Azure AD Connect kommunikálni az Azure AD használatával a TLS 1.0 alapértelmezés szerint ki van. Módosíthatja a TLS 1.2 lépéseit [TLS 1.2 engedélyezése az Azure AD Connect](#enable-tls-12-for-azure-ad-connect).
...
Az Azure AD Connect használja a TLS 1.0 alapértelmezés szerint a Szinkronizáló vezérlő kiszolgálója és az Azure AD közötti kommunikáció titkosításához. .Net-alkalmazások a TLS 1.2 alapértelmezés szerint a kiszolgálón az konfigurálásával módosíthatja. További információ a TLS 1.2 megtalálhatók [Microsoft biztonsági tanácsadó 2960358](https://technet.microsoft.com/security/advisory/2960358).
