...
Azure Active Directory (Azure AD) segítségével meghatározhat külön rendszergazdák számára, hogy különféle célokat szolgál. Ezek a rendszergazdák hozzáféréssel fognak rendelkezni a különböző funkciókhoz az Azure Portalon vagy a klasszikus Azure portálon, illetve a szerepkörtől függően képesek lesznek többek között felhasználókat létrehozni és szerkeszteni, rendszergazdai szerepköröket hozzárendelni másokhoz, felhasználói jelszavakat alaphelyzetbe állítani és felhasználói licenceket, valamint tartományokat kezelni. A rendszergazda szerepkörrel felruházott felhasználó ugyanazokkal az engedélyekkel rendelkeznek az összes a felhőszolgáltatások, amelyek a szervezet fizet elő, függetlenül attól, hogy rendelje hozzá a szerepkört az Office 365 portál és a klasszikus Azure portálon vagy az Azure AD-modul segítségével  a Windows PowerShell környezethez.
