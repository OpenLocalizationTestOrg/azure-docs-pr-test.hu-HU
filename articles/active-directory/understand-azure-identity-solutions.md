...
|Azure-előfizetési rendszergazda| A fiókadminisztrátor az a személy, aki regisztrált a vagy vásárolt Azure-előfizetést. Használhatnak a [Account Center](https://account.windowsazure.com/Home/Index) például előfizetések létrehozása különböző felügyeleti feladatok elvégzésére, előfizetések megszakítja, módosíthatja az előfizetés számlázási, vagy a szolgáltatás rendszergazdájával. |
