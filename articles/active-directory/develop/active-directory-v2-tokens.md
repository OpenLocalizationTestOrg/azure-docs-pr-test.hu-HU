...
| előnyben részesített felhasználónév |`preferred_username` |`thegreatbambino@nyy.onmicrosoft.com` |Elsődleges felhasználóneve, amely a felhasználót a v2.0-végpontra jelöli. Ez lehet egy e-mail címet, telefonszámot vagy egy általános felhasználónév nélkül a megadott formátumban. Az érték változtatható és idővel változhatnak. A `profile` hatókör ezt az igényt fogadásához szükséges. |
