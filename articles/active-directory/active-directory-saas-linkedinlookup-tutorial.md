...
Ebben az oktatóanyagban elsajátíthatja, hogyan toointegrate LinkedIn keresési az Azure Active Directoryval (Azure AD).

LinkedIn keresési integrálása az Azure AD lehetővé teszi a következő előnyöket hello:

- Megadhatja a hozzáférés tooLinkedIn keresési rendelkező Azure AD-ben
- Engedélyezheti a felhasználók tooautomatically get bejelentkezett tooLinkedIn keresési (egyszeri bejelentkezés) a saját Azure AD-fiókok
...
az Azure AD integrálása LinkedIn keresési tooconfigure, kell a következő elemek hello:
...
1. Hello gyűjteményből LinkedIn keresési hozzáadása
2. És tesztelés az Azure AD konfigurálása egyszeri bejelentkezés

## <a name="adding-linkedin-lookup-from-hello-gallery"></a>Hello gyűjteményből LinkedIn keresési hozzáadása
tooconfigure hello integrációs LinkedIn-keresés, az Azure AD-be, meg kell tooadd LinkedIn keresési hello gyűjtemény tooyour felügyelt SaaS-alkalmazások listája.

**tooadd LinkedIn keresési hello gyűjteményből, hajtsa végre a lépéseket követve hello:**
...
4. Hello keresési mezőbe, írja be a **LinkedIn keresési**.
...
5. A hello eredmények panelen válassza ki a **LinkedIn keresési**, és kattintson a **Hozzáadás** tooadd hello alkalmazás gombra.
...
Az egyszeri bejelentkezés toowork az Azure AD kell tooknow milyen hello megfelelőjére felhasználó LinkedIn keresési tooa felhasználói az Azure ad-ben. Ez azt jelenti egy Azure AD-felhasználó és a kapcsolódó felhasználó hello LinkedIn keresési közötti kapcsolat kapcsolatot kell létrehozni toobe.

Ez a hivatkozás kapcsolat létesíti hello hello értékkel **felhasználónév** hello értékeként hello Azure AD-ben **felhasználónév** LinkedIn keresés.

tooconfigure és az Azure AD az egyszeri bejelentkezés LinkedIn keresési-teszthez, a következő építőelemeket toocomplete hello szüksége:

1. **[Az Azure AD az egyszeri bejelentkezés konfigurálása](#configuring-azure-ad-single-sign-on)**  -tooenable a felhasználók toouse ezt a szolgáltatást.
2. **[Az Azure AD tesztfelhasználó létrehozása](#creating-an-azure-ad-test-user)**  -tootest az Azure AD egyszeri bejelentkezést a Britta Simon.
3. **[Egy LinkedIn keresési tesztfelhasználó létrehozása](#creating-an-linkedin-lookup-test-user)**  -toohave egy megfelelője a Britta Simon LinkedIn-keresés, amely az Azure AD csatolt toohello megjelenítése.
4. **[Hozzárendelése az Azure AD hello tesztfelhasználó](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse az Azure AD egyszeri bejelentkezést.
5. **[Egyszeri bejelentkezés tesztelése](#testing-single-sign-on)**  -tooverify e hello konfigurációs működik.

### <a name="configuring-azure-ad-single-sign-on"></a>Az Azure AD az egyszeri bejelentkezés konfigurálása

Ebben a szakaszban az Azure AD az egyszeri bejelentkezés az Azure-portálon hello engedélyezése, és a LinkedIn keresési alkalmazásban egyszeri bejelentkezés konfigurálása.

**tooconfigure az Azure AD egyszeri bejelentkezést a LinkedIn-kereséssel, hajtsa végre a lépéseket követve hello:**

1. Az Azure portál, a hello hello **LinkedIn keresési** alkalmazás integráció lapján, kattintson a **egyszeri bejelentkezés**.
...
3. Egy másik webes böngészőablakban, a bejelentkezés tooyour **LinkedIn keresési** webhely rendszergazdaként.

4. A **Account Center**, kattintson a **globális beállítások** alatt **beállítások**. Jelölje ki, **keresési** hello legördülő listából.
...
6. Az Azure-portál a **LinkedIn keresési tartomány és az URL-címek** csoportjában hajtsa végre a következő lépéseket, ha tooconfigure hello alkalmazás hello **IDP** kezdeményezett mód:
...
7. Ellenőrizze **megjelenítése speciális URL-beállításainak**, ha tooconfigure hello alkalmazás **SP** kezdeményezett mód:
    ...
    A hello **bejelentkezési URL-cím** szövegmezőhöz URL-címet a következő mintát hello használatával írja be:`https://www.linkedIn.com/checkpoint/enterprise/login/<AccountId>?application=lookup`
     
    > [!NOTE] 
    > Ez nem valódi értékek. hello felhasználó rendelkezik tooupdate ezeket az értékeket hello a tényleges bejelentkezési URL-CÍMÉT. Ügyfél [LinkedIn keresési ügyfél-támogatási csoport](https://business.LinkedIn.com/lookup) tooget ezt az értéket.

8. A **LinkedIn keresési** alkalmazás hello SAML helyességi feltételek vár egy meghatározott formátumban. hello felhasználó rendelkezik-e tooadd egyéni attribútum hozzárendelések toohello SAML token attribútumok konfigurációja. a következő képernyőkép hello példáját mutatja be. alapértelmezett értékének hello **felhasználói azonosító** van **user.userprincipalname** de LinkedIn keresési vár a toobe leképezve hello a felhasználó e-mail címét. Használhat **user.mail** hello lista attribútumot, vagy használja a szervezet konfiguráció alapján hello megfelelő attribútum értéke. 
...
9. A **felhasználói attribútumok** kattintson **nézet és egyéb felhasználói attribútumok szerkesztése** és hello attribútumainak beállítása. hello felhasználó számára szükséges tooadd négy jogcímek nevű **e-mail**, **részleg**, **Keresztnév**, és **Vezetéknév** hello értéke pedig leképezve toobe **user.mail**, **felhasználó.részleg**, **user.givenname**, és **user.surname** kulcsattribútumokkal.
    ...
    a. Kattintson a **attribútum hozzáadása** tooopen hello **attribútum hozzáadása** párbeszédpanel.
...
12. Nyissa meg túl**LinkedIn rendszergazdai beállítások** szakasz. Feltöltés hello XML-fájl hello kattintva hello Azure-portálon letöltésének **feltöltése XML-fájl** lehetőséget.
...
13. Kattintson a **a** tooenable egyszeri Bejelentkezést. Egyszeri bejelentkezés állapota a **nincs csatlakoztatva** túl**csatlakoztatva**
...
3. Kattintson a **Hozzáadás** tooopen hello **felhasználói** párbeszédpanel.
...
Csatolt keresési alkalmazás támogatja a csak az idő szerinti (JIT) a felhasználók átadása, miután a felhasználók hitelesítésére hello alkalmazás automatikusan létrejönnek. Aktiválása **automatikusan a szükséges licencek kiosztása** tooassign licenc toohello felhasználó.
...
Ebben a szakaszban a Britta Simon toouse Azure egyszeri bejelentkezés hozzáférés tooLinkedIn keresési megadásával engedélyeznie.

![Felhasználó hozzárendelése][200] 

**tooassign Britta Simon tooLinkedIn keresési, hajtsa végre a következő lépéseket hello:**

1. A hello Azure-portálon, nyissa meg hello alkalmazások megtekintése, és majd toohello könyvtár nézetben keresse meg és nyissa meg túl**vállalati alkalmazások** kattintson **összes alkalmazás**.

    ![Felhasználó hozzárendelése][201] 

2. Hello alkalmazások listában válassza ki a **LinkedIn keresési**.
...
Amikor hello LinkedIn keresési hello hozzáférési Panel csempére kattint, melyekben tooprovide a személyes LinkedIn fiókadatok átirányított tooOrganizational lapon kell. A személyes fiókot a LinkedIn üzleti fiókjával hivatkozik. 
