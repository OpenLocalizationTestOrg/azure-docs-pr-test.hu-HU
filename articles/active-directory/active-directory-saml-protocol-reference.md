...
Amikor egy alkalmazás regisztrálása az Azure AD hello alkalmazás fejlesztőjének az Azure AD összevonási kapcsolatos információk regisztrálja. Ez magában foglalja a hello **átirányítási URI-** hello alkalmazás.
