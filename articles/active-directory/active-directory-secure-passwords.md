...
Ez a cikk ismerteti, amelyek néhány ajánlott eljárás követésével egy olyan felhasználó nevében, vagy arra, hogy az Azure Active Directory (Azure AD) vagy a Microsoft Account rendszergazdaként.
 ...
 >
 > Felhasználók visszaállíthatják a saját jelszavát útmutatásának megfelelően történt a cikkben található [elfelejtettem a saját Azure AD-jelszó súgó](active-directory-passwords-update-your-own-password.md).
 >
