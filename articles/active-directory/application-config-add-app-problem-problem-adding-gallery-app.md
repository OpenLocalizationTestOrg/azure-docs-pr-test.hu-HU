...
Ez a cikk segítséget toounderstand hello gyakori problémák személyek arcfelismerési Azure AD-katalógusában alkalmazások és mit tehet hozzáadásakor tooresolve őket.
...
Ha alkalmazások megtanulni segítségre van szüksége, hello [oktatóanyagok lista ismerteti tooIntegrate SaaS-alkalmazásokhoz az Azure Active Directoryval](https://docs.microsoft.com/azure/active-directory/active-directory-saas-tutorial-list) cikk egy remek toostart.

A hozzáadása toothis hello [az Azure AD-alkalmazások dokumentumtár](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) toolearn kapcsolatos további információkért az egyszeri bejelentkezés az Azure ad-vel és annak működéséről.
...
6.  Hello kattintson **másolása** **ikon** toohello sarkában hello **hiba másolása** szövegmező toocopy összes hello értesítési részletek tooshare a támogatási szolgálathoz vagy a termék csoport visszafejtés
