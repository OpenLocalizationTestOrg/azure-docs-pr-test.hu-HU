...
---
# <a name="create-service-manager-web-app-using-hello-automated-script-preview"></a>Automatikus hello parancsfájl (előzetes verzió) használatával a Service Manager webalkalmazás létrehozása

A következő parancsfájl toocreate hello webalkalmazást a Service Manager-példány hello használata. További információ a Service Manager-kapcsolat a következő helyen: [Service Manager-webalkalmazás](log-analytics-itsmc-connections.md#create-and-deploy-service-manager-web-app-service)
...
hello parancsfájlt hoz létre hello Web app használatával Ön által megadott hello nevét (néhány további karakterláncok toomake együtt az egyedi). Hello generál **webes alkalmazás URL-címhez**, **ügyfél-azonosító** és **ügyfélkulcs**.
...
Windows 10 5.1 alapértelmezés szerint rendelkezik. Letöltheti a hello keretrendszer [Itt](https://www.microsoft.com/download/details.aspx?id=53347):

A következő parancsfájl hello használata:
...
[A hibrid kapcsolat hello konfigurálása](log-analytics-itsmc-connections.md#configure-the-hybrid-connection).
