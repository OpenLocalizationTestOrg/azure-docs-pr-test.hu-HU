...
> [!NOTE]
> Az Azure Log Analytics-összekötő Microsoft Flow szükséges a munkaterület frissíteni kell az új Naplóelemzési lekérdezési nyelv. További információ az új nyelv, és a frissítés a következő munkaterület eljárás első [Azure Naplóelemzési munkaterület frissítése új naplófájl-keresési](log-analytics-log-search-upgrade.md).  
