...
Fontos, hogy hangsúlyt ebben az esetben is **indítása és leállítása, ezek a szakaszok**, amelyek nem részére történő átadására kötelezik áthelyezése a következő szakaszára. Most nézzük példák az alábbi szakaszok.

**Emelje fel, és az eltolás mértékét megadó** -vállalat nagy számú feloldása, és a meglévő egységes alkalmazások időeltolású tárolók be két okból;
