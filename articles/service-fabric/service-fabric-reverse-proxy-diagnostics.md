...
3. A fordított proxykiszolgálóhoz kérelem időtúllépési hiba miatt sikertelen. 
    ...
    Ha a szolgáltatás visszaküldi a 404 állapotkódot a felhasználó, azt kell csatolni kell egy "X-ServiceFabric" fejlécet. Miután úgy javította ki ez, jelenik meg, hogy fordított proxy állapotkód továbbítja az ügyfélnek.  

4. Olyan esetekben, amikor az ügyfél a kérés megszakadt.

    Az alábbi esemény rögzítése Ha fordított proxy továbbító ügyfél válasz, azonban az ügyfél kapcsolata megszakad:
