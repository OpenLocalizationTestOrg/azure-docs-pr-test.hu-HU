...
Amikor egy alkalmazás típus adott verziójának már nem szükséges, meg kell regisztrációját használt alkalmazások típusa a [Unregister-ServiceFabricApplicationType](/powershell/module/servicefabric/unregister-servicefabricapplicationtype?view=azureservicefabricps) parancsmag. Az image store által felhasznált tárterület nem használt alkalmazástípus regisztrációjának kiadását. Az alkalmazástípus regisztrációjának törlése lehet, mindaddig, amíg nincs alkalmazások létrehozásának rajta, és nem alkalmazás függőben lévő frissítések hivatkozik rá.
...
Ha már nincs szükség egy alkalmazáscsomagot, törölheti a lemezképtárolóból rendszererőforrások felszabadítása érdekében.
...
Probléma: Feltöltés csomag sikeresen befejeződött, de [Register-ServiceFabricApplicationType](/powershell/module/servicefabric/register-servicefabricapplicationtype?view=azureservicefabricps) túllépi az időkorlátot.
Próbálja meg:
