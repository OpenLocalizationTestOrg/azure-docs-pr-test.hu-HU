...
#### [Hello ügyfél SDK használata](app-service-mobile-android-how-to-use-client-library.md)
...
#### [Hello ügyfél SDK használata](app-service-mobile-ios-how-to-use-client-library.md)
...
#### [Hello ügyfél SDK használata](app-service-mobile-dotnet-how-to-use-client-library.md)
...
### Webes feladatok
#### [Mi az Azure WebJobs SDK hello](../app-service-web/websites-dotnet-webjobs-sdk.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Hogyan toouse Azure blob-tároló hello WebJobs SDK a](../app-service-web/websites-dotnet-webjobs-sdk-storage-blobs-how-to.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Hogyan toouse Azure várólista hello WebJobs SDK szolgáltatással](../app-service-web/websites-dotnet-webjobs-sdk-storage-queues-how-to.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Hogyan toouse Azure Service Bus a hello WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk-service-bus.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Hogyan toouse Azure table storage a hello WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk-storage-tables-how-to.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Hogyan tooCreate egy ILB ASE használata Azure Resource Manager-sablonok](../app-service-web/app-service-app-service-environment-create-ilb-ase-resourcemanager.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [TooApp szolgáltatás telepítése](../app-service-web/web-sites-deploy.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Hogyan toocontrol bejövő forgalom](../app-service-web/app-service-app-service-environment-control-inbound-traffic.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
## Migrate (Áttelepítés)
### [Hogyan hasonlítsa össze a App Service tooMobile szolgáltatások?](app-service-mobile-value-prop-migration-from-mobile-services.md)
### [Egy meglévő Mobile Service tooApp szolgáltatás áttelepítése](app-service-mobile-migrating-from-mobile-services.md)
### Egy meglévő Mobile Service tooApp szolgáltatás frissítése
...
#### [Biztonságos kapcsolódás tooBackend erőforrások](../app-service-web/app-service-app-service-environment-securely-connecting-to-backend-resources.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [REST tooback használja, és állítsa vissza az App Service-alkalmazásokhoz](../app-service-web/websites-csm-backup.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [Hogyan toosend a levelezéshez SendGrid az Azure-ral](../app-service-web/sendgrid-dotnet-how-to-send-email.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [TooPowerApps és a Microsoft Flow exportálása](../app-service/app-service-export-api-to-powerapps-and-flow.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [Diagnosztikai naplózás engedélyezése](../app-service-web/web-sites-enable-diagnostic-log.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Folyamatos átviteli naplók és hello konzol](../app-service-web/web-sites-streaming-logs-and-console.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Hibaelhárítás a Visual Studióval](../app-service-web/web-sites-dotnet-troubleshoot-visual-studio.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
