...
---
# <a name="using-the-azure-importexport-tool-v1"></a>Az Azure Import/Export eszközzel (v1)
...
Ez a dokumentáció az Azure Import/Export eszköz v1 szolgál. Az eszköz legújabb verziójának használatával kapcsolatos információkért lásd: [az Azure Import/Export eszközzel](storage-import-export-tool-how-to.md).
