...
* Egy Azure-tárfiók. Ha még nem rendelkezik egy tárfiókot, létrehozhat egyet a következő lépések [hozzon létre egy Tárfiókot](storage-create-storage-account.md#create-a-storage-account).
...
További információk is: a [Java fejlesztői központ](https://azure.microsoft.com/develop/java/).