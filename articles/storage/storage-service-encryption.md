...
Az Azure File storage kínál a felhőben, szabványos SMB protokollt használó fájlmegosztások. Egy fájlmegosztást csatlakoztathatnak egy ügyfél a helyszínen vagy az Azure-ban. Ha csatlakoztatva, és eszközöket, például a Robocopy használatával lehet fájlokat másolja át az Azure fájlmegosztások. További információkért lásd: [csatlakoztatásáról Azure fájlmegosztás Windows rendszeren](storage-file-how-to-use-files-windows.md) és [Azure fájlmegosztás csatlakoztatásáról Linux](storage-how-to-use-files-linux.md).
...
További információkért látogasson el a [az Azure Blob storage .NET használatának első lépései](storage-dotnet-how-to-use-blobs.md).
