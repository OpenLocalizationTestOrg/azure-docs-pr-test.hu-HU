...
Az Azure File storage hello szabványos SMB protokollt használó hello felhőben fájlmegosztásokat kínál. Egy fájlmegosztást csatlakoztathatnak egy ügyfél a helyszínen vagy az Azure-ban. Ha csatlakoztatva, és eszközöket, például a Robocopy lehet használt toocopy fájlok fájlmegosztások tooAzure keresztül. További információkért lásd: [hogyan toomount Azure fájlmegosztás Windows rendszeren](storage-file-how-to-use-files-windows.md) és [hogyan toomount Azure-fájl megosztása Linux](storage-how-to-use-files-linux.md).
...
toolearn több, látogasson el a [az Azure Blob storage .NET használatának első lépései](storage-dotnet-how-to-use-blobs.md).
