...
Az alábbi példa feltölti a tartalmát a **sunset.png** fájlt a **myblob** blob.
...
A következő példa bemutatja, hogy használatával **beolvasása\_blob\_való\_elérési** tartalmának letöltése a **myblob** blob-, és tárolja a a **out-sunset.png** fájlt.
