...
Nincsenek más módokon toolist hello tartalmát egy blob-tároló. Lásd: [az Azure Blob storage .NET használatának első lépései](storage-dotnet-how-to-use-blobs.md#list-the-blobs-in-a-container) további információt.
...
Más módon toosave blobokat fájlokba. Lásd: [az Azure Blob storage .NET használatának első lépései](storage-dotnet-how-to-use-blobs.md#download-blobs) további információt.
