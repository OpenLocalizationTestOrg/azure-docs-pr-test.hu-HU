...
Példa a hello hello környezeti változók beállítása [Azure-portálon](https://portal.azure.com) Azure-webalkalmazás, lásd: [Node.js web app használatával hello Azure Table szolgáltatás](../../app-service-web/storage-nodejs-use-table-storage-web-site.md).
...
[Létrehozása és telepítése a Node.js web app tooAzure Web Matrix]: https://www.microsoft.com/web/webmatrix/  
