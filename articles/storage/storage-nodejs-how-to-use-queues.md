...
Üres Node.js-alkalmazás létrehozása. A Node.js-alkalmazás létrehozása utasításokért lásd: [Node.js-webalkalmazás létrehozása az Azure App Service], [és üzembe egy Node.js-alkalmazás tooan Azure Cloud Service] a Windows PowerShell vagy [ Hozza létre és telepítheti a Node.js web app tooAzure Web Matrix].
...
* A Microsoft hello [Azure Storage csapat blogja][Azure Storage Team Blog].
