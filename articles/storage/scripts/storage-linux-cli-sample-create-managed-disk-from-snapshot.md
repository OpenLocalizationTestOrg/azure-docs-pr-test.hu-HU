...
[!code-azurecli[fő](../../../cli_scripts/storage/create-managed-disks-from-snapshot/create-managed-disks-from-snapshot.sh "létrehozás felügyelt lemezes pillanatképből")]
