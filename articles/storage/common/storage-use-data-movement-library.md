...
a Microsoft Azure Storage adatátviteli könyvtár hello a platformok közötti nyílt forráskódú-szalagtár egyik célja a nagy teljesítményű feltöltését, letöltése és az Azure Storage Blobs és a fájlok másolása. Ebben a könyvtárban hello alapvető adatátviteli keretrendszeren, amely rendszert működtet [AzCopy](../storage-use-azcopy.md). Adatátviteli könyvtár hello biztosít, amelyek nem érhetők el a hagyományos a kényelmes módszert [.NET Azure Storage ügyféloldali kódtár](../blobs/storage-dotnet-how-to-use-blobs.md). Ez magában foglalja a hello képességét tooset hello párhuzamos műveletek számát, nyomon követése átvitel állapota, egyszerűen folytathatja a megszakított átvitel, és még sok más.  
