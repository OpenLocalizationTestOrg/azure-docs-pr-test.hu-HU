...
Egy részletes oktatóanyag, amely végigvezeti Önt a hello folyamat blobok ügyféloldali titkosítás és az Azure Key Vault használatával titkosítja, lásd: [titkosítása és visszafejtése az Azure Key Vault használatával a Microsoft Azure Storage blobs](../blobs/storage-encrypt-decrypt-blobs-key-vault.md).
