...
* **Q. Mikor használjak Azure File vs Azure Blob vs Azure lemez?**  
    ...
    A további [Deciding, amikor toouse Azure Blobok, Azure-fájlok vagy Azure adatlemezek](storage-decide-blobs-files-disks.md)
...
* **Q. Hogyan kezdjem el az Azure File storage?**  
    ...
    * [Ismerje meg, hogyan toocreate Azure-fájl megosztása hello portál használatával](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Ismerje meg, hogyan toocreate Azure-fájl megosztása Powershell használatával](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Ismerje meg, hogyan toocreate Azure-fájl megosztása parancssori felület használatával](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **Q. Az Azure File storage hello skálázási korlátai**
    Az Azure File storage méretezhetőségi és Teljesítménycélok információkért lásd: [Azure Storage méretezhetőségi és teljesítménycéloknak](storage-scalability-targets.md#scalability-targets-for-blobs-queues-tables-and-files).
...
* **Q. Hogyan hibáinak elhárítása az Azure File storage hibák?**
    ...
    Olvassa el a túl[Azure File storage hibaelhárítási cikk](storage-troubleshoot-file-connection-problems.md) végpont hibaelhárítási útmutatót. 
...
* [Az Azure Storage hello Azure parancssori felület használatával](storage-azure-cli.md)
* [Az Azure File Storage-problémák hibaelhárítása](storage-troubleshoot-file-connection-problems.md)
