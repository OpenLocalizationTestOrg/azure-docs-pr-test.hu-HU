...
* **Q. Mikor használjak Azure File vs Azure Blob vs Azure lemez?**  
    ...
    A további [való Azure BLOB, Azure-fájlok vagy Azure adatlemezek használata](storage-decide-blobs-files-disks.md)
...
* **Q. Hogyan kezdjem el az Azure File storage?**  
    ...
    * [Útmutató a portál használatával Azure fájlmegosztás létrehozása](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Útmutató Powershell-lel Azure fájlmegosztás létrehozása](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Útmutató: Azure parancssori felület használatával fájlmegosztás létrehozása](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **Q. Hogyan hibáinak elhárítása az Azure File storage hibák?**
    ...
    Olvassa el a [Azure File storage hibaelhárítási cikk](storage-troubleshoot-file-connection-problems.md) végpont hibaelhárítási útmutatót. 
