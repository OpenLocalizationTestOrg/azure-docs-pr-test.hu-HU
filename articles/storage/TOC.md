...
### [Egy felügyelt lemezes tooa Windows virtuális gép csatlakoztatása PowerShell használatával](../virtual-machines/windows/attach-disk-ps.md)
...
### [Névtelen hozzáférés tooblobs](storage-manage-access-to-resources.md)
...
### [Azure virtuális gépek tooAzure kezelt lemezek áttelepítése](../virtual-machines/windows/migrate-to-managed-disks.md)
### [AWS és más platformokra tooManaged lemezek áttelepítése](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Áttelepítése tooPremium tárolást biztosít az Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [TooPremium tároló áttelepítése](storage-migration-to-premium-storage.md)
...
### [Hello Storage Emulator használata](storage-use-emulator.md)
...
## Adatátvitel
### [Helyezze át az adatokat tooand tárolóból](storage-moving-data.md)
### [AzCopy Windowson](storage-use-azcopy.md)
### [AzCopy Linuxon](storage-use-azcopy-linux.md)
### [Hello Import/Export szolgáltatás használata](storage-import-export-service.md)
### [Hello Import/Export eszköz használatával](storage-import-export-tool-how-to.md)
#### [Hello Import/Export eszköz beállítása](storage-import-export-tool-setup.md)
...
#### [Hibaelhárítási hello Import/Export eszköz](storage-import-export-tool-troubleshooting-v1.md)
...
### [Hello Import/Export eszköz (v1) használatával](storage-import-export-tool-how-to-v1.md)
#### [Hello Import/Export eszköz beállítása](storage-import-export-tool-setup-v1.md)
...
#### [Az Import/Export szolgáltatás metaadat- és tulajdonságfájljainak formátuma](storage-import-export-file-format-metadata-and-properties.md)
#### [Az Import/Export szolgáltatás naplófájljainak formátuma](storage-import-export-file-format-log.md)
### [Hello Azure Import/Export szolgáltatás REST API használatával](storage-import-export-using-the-rest-api.md)
