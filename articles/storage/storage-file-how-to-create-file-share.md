...
egy Azure fájlmegosztás toocreate, használhatja a storage-fiók, amely már létezik, vagy [hozzon létre egy új Azure-tárfiók](storage-create-storage-account.md). egy Azure fájlmegosztás PowerShell toocreate, szüksége lesz hello fiókkulcs és a tárfiók nevét... Ha azt tervezi, hogy a Powershell vagy a CLI toouse kell Tárfiók kulcsa.
...
2. **Kattintson a Fájlmegosztás hozzáadása gombra**:    
    ![Kattintson a hello fájl megosztás gomb hozzáadása](media/storage-file-how-to-create-file-share/create-file-share-portal2.png)

3. **Adja meg a nevet és a kvótát. A kvóta jelenleg legfeljebb 5 TB lehet**:    
    ![Adjon meg egy nevet és a kívánt kvóta hello Új fájlmegosztás](media/storage-file-how-to-create-file-share/create-file-share-portal3.png)
