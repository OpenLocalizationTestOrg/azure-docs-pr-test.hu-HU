...
3. A Microsoft Update katalógus hello hello a keresési mezőbe, írja be a hello Tudásbázis (KB) száma hello gyorsjavítás kívánt toodownload, például **3121901**, és kattintson a **keresési**.
   
    hello gyorsjavítás lista megjelenik, például **összegző szoftverfrissítési csomagot frissítés 2.0 a StorSimple 8000 Series**.
...
5. Keressen további gyorsjavítások a fenti hello táblázatban felsorolt (**3121900**, **3080728**, **3090322**, és **3121899**), és adja hozzá mindegyik hello kosár.
...
7. Ellenőrizze a hello rendszer szoftververziók. Típus:
...
8. Ismételje meg a 3-5 tooinstall hello fennmaradó normál módú gyorsjavítások.
   
   * hello LSI illesztőprogram - KB3121900
   * hello Storport frissítése – KB3080728
   * hello Spaceport frissítése – KB3090322
