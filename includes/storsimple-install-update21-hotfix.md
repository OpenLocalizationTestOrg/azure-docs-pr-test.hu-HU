...
3. A Microsoft Update katalógus hello hello a keresési mezőbe, írja be a hello Tudásbázis (KB) száma hello gyorsjavítás kívánt toodownload, például **3179904**, és kattintson a **keresési**.
   
    hello gyorsjavítás lista megjelenik, például **összegző szoftverfrissítési csomagot frissítés 2.2 a StorSimple 8000 Series**.
...
5. Keressen további gyorsjavítások a fenti hello táblázatban felsorolt (**3103616**, **3146621**), és adja hozzá az egyes toohello kosár.
...
4. Típus **Y** amikor felszólító tooconfirm hello gyorsjavítás telepítése.
   ...
   > [!IMPORTANT]
   > 2.2-es frissítés telepítése esetén csak hello bináris fájl végrehajtásával kerüli meg a "minden-hcsmdssoftwareudpate" telepítéséhez. Nem hello Cis és hello MDS ügynök frissítés telepítése előtt a minden-cismdsagentupdatebundle létrehozás. Hiba toodo így eredményez hiba. 
...
1. Hello szoftverfrissítés befejeződése után ellenőrizze a hello rendszer szoftververziók. Típus:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Ismételje meg a 3-5 tooinstall hello fennmaradó normál módú gyorsjavítások.
   
   * hello iSCSI frissítés KB3146621
   * hello WMI frissítés KB3103616
3. Kihagyhatja ezt a lépést, a 2. frissítés frissítésekor. Ha egy verziója előzetes tooUpdate 2 frissít, toodownload is szüksége lesz:

    - hello LSI illesztőprogram KB3121900

    - hello Spaceport frissítés KB3090322

    - hello Storport frissítés KB3080728
