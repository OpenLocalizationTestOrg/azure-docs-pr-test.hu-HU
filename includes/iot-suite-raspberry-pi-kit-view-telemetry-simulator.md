...
- Válasszon **InvokeMethod**. hello szimulátor hello konzolon egy üzenetet jelenít meg hello málna Pi. hello málna Pi hello alkalmazás küld egy visszaigazoló hátsó toohello megoldás irányítópultja:
