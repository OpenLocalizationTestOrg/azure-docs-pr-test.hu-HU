Néhány metrikákkal és eseményekkel alkalmazásonként hello száma korlátozott (Ez azt jelenti, hogy egyes instrumentation kulcs). Korlátok függenek hello [terv árképzési](https://azure.microsoft.com/pricing/details/application-insights/) választott.
...
| Szabályozás | 32 ezer esemény/másodperc | hello korlát egy percben értendő.
