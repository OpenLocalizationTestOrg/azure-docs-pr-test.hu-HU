...
| Windows Server-szerepkörök | Ne engedélyezze a következő szerepkörök hello: <br> - Active Directory tartományi szolgáltatások <br>– Internet Information Services <br> - Hyper-V |
| **Hálózat** | |
| Hálózati adapter típusa | VMXNET3 |
| IP-cím típusa | Statikus |
| Internetelérés | hello kiszolgálójának kell lennie a következő URL-címek közvetlenül vagy proxykiszolgálón keresztül képes tooaccess hello: <br> - \*.accesscontrol.windows.net<br> - \*.backup.windowsazure.com <br>- \*.store.core.windows.net<br> - \*.blob.core.windows.net<br> - \*.hypervrecoverymanager.windowsazure.com <br> - https://cdn.mysql.com/archives/mysql-5.5/mysql-5.5.37-win32.msi (nem szükséges kibővíthető folyamatkiszolgálókhoz) <br> - time.nist.gov <br> - time.windows.com |
